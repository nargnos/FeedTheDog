...
namespace ClusterCommands
{
	...
	void ClusterAddslots(std::ostream& out)
	{
	...
	void ClusterCountFailureReports(std::ostream& out, const std::string& id)
	{
        GenCmd(out, "CLUSTER COUNT-FAILURE-REPORTS", id);
	}

    // CLUSTER COUNTKEYSINSLOT slot
    // Return the number of local keys in the specified hash slot
	void ClusterCountkeysinslot(std::ostream& out)
	{
	...
	void ClusterDelslots(std::ostream& out)
	{
	...
	void ClusterForget(std::ostream& out, const std::string& id)
	{
        GenCmd(out, "CLUSTER FORGET", id);
	}

    // CLUSTER GETKEYSINSLOT slot count
    // Return local key names in the specified hash slot
	void ClusterGetkeysinslot(std::ostream& out)
	{
	...
	void ClusterMeet(std::ostream& out)
	{
        // TODO: CLUSTER MEET
	...
	void ClusterReplicate(std::ostream& out, const std::string& id)
	{
        GenCmd(out, "CLUSTER REPLICATE", id);
	}
	...
	void ClusterSetConfigEpoch(std::ostream& out)
	{
	...
	void ClusterSetslot(std::ostream& out)
	{
	...
	void ClusterSlaves(std::ostream& out, const std::string& id)
	{
        GenCmd(out, "CLUSTER SLAVES", id);
	}
